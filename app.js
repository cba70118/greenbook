...
(function() {
    ...
    TOURNAMENTS.forEach(function(t) {
        if (t.status === 'open') {
            openRows += '<tr><td>' + t.name + '</td><td>' + (t.phase || '') + '</td><td>' + t.bets + '</td><td>' + dollars(t.staked) + '</td><td>&mdash;</td><td style="color:var(--brass-400)">pending</td><td style="color:var(--brass-400)">OPEN</td></tr>';
            return;
        }
